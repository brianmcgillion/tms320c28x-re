...
pub struct Operand {
    ...
    /// The table's fine-grained operand kind. op_type collapses Imm4/Imm16/Shift4
    /// etc. into Immediate, which loses the distinction a lifter needs to tell a
    /// shift amount from a value to store.
    pub op_kind: OpType,
    pub value: i32,
    pub name: &'static str,
